							  ...
							  const SCostingInfo *pci)
{
	...
	ULONG ulCummulativeUnindexedPredCount = 0;
	...
	if (COperator::EopPhysicalIndexScan == op_id)
	{
		...
		ulCummulativeUnindexedPredCount = ptr->ResidualPredicateSize();
	}
	else
	{
